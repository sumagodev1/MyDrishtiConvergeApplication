...
(function(X, L) {
    ...
    L(a, "Core/Renderer/HTML/AST.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function(a, u) {
        ...
        u = function() {
            ...
            c.filterUserAttributes =
                function(e) {
                    q(e, function(a, f) {
                        var h = !0; - 1 === c.allowedAttributes.indexOf(f) && (h = !1); - 1 !== ["background", "dynsrc", "href", "lowsrc", "src"].indexOf(f) && (h = B(a) && c.allowedReferences.some(function(c) {
            ...
            a.prototype.complexColor = function(b, g, z) {
                ...
                d(this.renderer, "complexColor", {
                    ...
                    if (r) {
                        ...
                        "radialGradient" === r && n && !K(a.gradientUnits) && (I = a, a = F(a, Q.getRadialAttr(n, I), {
                            gradientUnits: "userSpaceOnUse"
                        }));
                        D(a, function(b, d) {
                            "id" !== d && h.push(d, b)
    ...
    L(a, "Core/Renderer/SVG/SVGLabel.js", [a["Core/Renderer/SVG/SVGElement.js"], a["Core/Utilities.js"]], function(a, u) {
        ...
        return function(h) {
            ...
            f.prototype.alignSetter = function(c) {
                ...
                c !== this.alignFactor && (this.alignFactor = c, this.bBox && y(this.xSetting) && this.attr({
                    x: this.xSetting
                }))
            };
    ...
    L(a, "Core/Axis/Tick.js", [a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function(a, u, E) {
        ...
        u = function() {
            ...
            m.prototype.addLabel = function() {
                ...
                G(D) || c.movedLabel ? D && D.textStr !== l && !F && (!D.textWidth || k.style.width || D.styles.width || D.css({
                    width: null
                }), D.attr({
                    text: l
        ...
        a = function() {
            ...
            a.prototype.zoom = function(b, a) {
                ...
                d(this, "zoom", b, function(b) {
                    var a = b.newMin,
                        d = b.newMax;
                    if (a !== g.min || d !== g.max) g.allowZoomOutside || (l(c) && (a < r && (a = r), a > f && (a = f)), l(k) && (d < r && (d = r), d > f && (d = f))), g.displayBtn = "undefined" !== typeof a || "undefined" !== typeof d, g.setExtremes(a, d, !1, void 0, {
                        trigger: "zoom"
                    });
                    b.zoomed = !0
                });
            ...
            a.prototype.renderUnsquish = function() {
                ...
                if (this.autoRotation) C > f && C > F.h ? h.rotation = this.labelRotation : this.labelRotation = 0;
                    ...
                    if (!D) {
                        ...
                        for (f = d.length; !e && f--;) {
                            var n = d[f];
                            if (n = g[n].label) n.styles && "ellipsis" === n.styles.textOverflow ? n.css({
                                    textOverflow: "clip"
                                }) : n.textPxLength > l && n.css({
                                    width: l + "px"
                                }), n.getBBox().height > this.len / d.length -
            ...
            a.prototype.addTitle = function(b) {
                var a = this.chart.renderer,
                    ...
                    e;
                this.axisTitle || ((e = c.textAlign) || (e = (d ? {
                    low: "left",
                    middle: "center",
                    high: "right"
                } : {
                ...
                k || c.style.width || this.isRadial || this.axisTitle.css({
                    width: this.len + "px"
                });
                ...
                function() {
                    ...
                    if (!a.axisGroup) {
                        var J = function(a, d, g) {
                            return c.g(a).attr({
                                zIndex: g
                            }).addClass("highcharts-" + b.coll.toLowerCase() + d + " " + (b.isRadial ? "highcharts-radial-axis" +
                                d + " " : "") + (q || "")).add(w)
                        };
            ...
            a.prototype.drawCrosshair = function(b, a) {
                ...
                if (g && !1 !== (l(a) || !c)) {
                    ...
                    r || (this.cross = r = k.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (c ? "category " : "thin ") + (g.className || "")).attr({
                            zIndex: C(g.zIndex, 2)
                        }).add(), k.styledMode ||
                        (r.attr({
        ...
        a = function() {
            ...
            a.prototype.getLabel = function() {
                ...
                if (!this.label) {
                    ...
                    b && g.shadow && (this.applyFilter(), this.label.attr({
            ...
            a.prototype.refresh = function(a, c) {
                ...
                if (d.enabled) {
                    ...
                    if (!1 === a) this.hide();
                        ...
                        else if (k = q, h = w, c && b.pointer.isDirectTouch && (k = c.chartX - b.plotLeft, h = c.chartY - b.plotTop), b.polar || !1 === C.options.clip || C.shouldShowTooltip(k, h)) c = this.getLabel(), d.style.width && !m || c.css({
                            width: this.chart.spacingBox.width + "px"
                        }), c.attr({
                            text: a && a.join ? a.join("") : a
                        }), c.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" +
                            l(f.colorIndex, C.colorIndex)), m || c.attr({
                            stroke: d.borderColor || f.color || C.color || E.neutralColor60
                        }), this.updatePosition({
                            plotX: q,
                            plotY: w,
                            negative: f.negative,
            ...
            a.prototype.renderSplit = function(a, k) {
                ...
                a = a.slice(0, k.length + 1).reduce(function(a, g, c) {
                    if (!1 !== g && "" !== g) {
                        ...
                        K || r.css(y.style).shadow(y.shadow).attr({
                            stroke: y.borderColor || c.color || F.color || E.neutralColor80
                        });
                        f = f.tt = r;
                        h = f.getBBox();
            ...
            a.prototype.updatePosition = function(a) {
                ...
                if (this.outside) {
                    ...
                    this.renderer.setSize(c.width +
                        f, c.height + f, !1);
                    if (1 !== b.scaleX || 1 !== b.scaleY) q(this.container, {
                        transform: "scale(" + b.scaleX + ", " + b.scaleY + ")"
                    }), e *= b.scaleX, d *= b.scaleY;
                    e += b.left - a.x;
                    d += b.top - a.y
                }
        ...
        a = function() {
                ...
                if (!J || !J.touch)
                    if (w < f ? w = f : w > f + h && (w = f + h), A < l ? A = l : A > l + C && (A = l + C), this.hasDragged = Math.sqrt(Math.pow(p - w, 2) + Math.pow(m - A, 2)), 10 < this.hasDragged) {
                        ...
                        d.hasCartesianSeries && (this.zoomX || this.zoomY) && u && !q && !J && (this.selectionMarker = J = d.renderer.rect(f, l, c ? 1 : h, e ? 1 : C, 0).attr({
                            ...
                            zIndex: 7
                        }).add(), d.styledMode || J.attr({
                            fill: b.selectionMarkerFill || v(E.highlightColor80).setOpacity(.25).get()
                        }));
                        J && c && (c = w - p, J.attr({
                            width: Math.abs(c),
                            x: (0 < c ? 0 : c) + p
            ...
            a.prototype.onContainerClick = function(a) {
                ...
                d.cancelClick || (b && this.inClass(a.target, "highcharts-tracker") ? (m(b.series, "click", e(a, {
                    point: b
                })), d.hoverPoint && b.firePointEvent("click", a)) : (e(a, this.getCoordinates(a)), d.isInsidePlot(a.chartX -
                    c, a.chartY - f, {
                        visiblePlotOnly: !0
                    }) && m(d, "click", a)))
            };
            ...
            a.prototype.runPointActions = function(d, c) {
                ...
                if (f && (f !== b.hoverPoint || g && g.isHidden)) {
                    ...
                    g && g.refresh(e ? l : f, d)
                } else c && g && !g.isHidden && (f = g.getAnchor([{}], d), b.isInsidePlot(f[0], f[1], {
                    visiblePlotOnly: !0
                }) && g.updatePosition({
                    plotX: f[0],
                    plotY: f[1]
            ...
            a.prototype.setDOMEvents = function() {
                ...
                u.hasTouch && (this.eventsToUnbind.push(q(c, "touchstart", this.onContainerTouchStart.bind(this), {
                        passive: !1
                    })), this.eventsToUnbind.push(q(c, "touchmove", this.onContainerTouchMove.bind(this), {
                        passive: !1
                    })),
                    a.unbindDocumentTouchEnd || (a.unbindDocumentTouchEnd = q(b, "touchend", this.onDocumentTouchEnd.bind(this), {
                        passive: !1
                    })))
            };
        ...
        u = function() {
            ...
            g.prototype.setState = function(b, d) {
                ...
                if (!(b === this.state && !d || this.selected && "select" !== b || !1 ===
                    ...
                    f && f.size && n && "hidden" !== A && !this.isCluster ? (v || (c.halo = v = w.renderer.path().add(n.parentGroup)), v.show()[d ? "animate" : "attr"]({
    ...
    L(a, "Core/Legend.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Series/Point.js"], a["Core/Utilities.js"]], function(a, u, E, H, x) {
        ...
        var d = function() {
            ...
            a.prototype.setText = function(a) {
                var b = this.options;
                a.legendItem.attr({
                    text: b.labelFormat ? B(b.labelFormat, a, this.chart) : b.labelFormatter.call(a)
                })
            };
            a.prototype.renderItem = function(a) {
                ...
                t || (a.legendGroup = d.g("legend-item").addClass("highcharts-" + q.type + "-series highcharts-color-" + a.colorIndex +
                    (u ? " " + u : "") + (n ? " highcharts-series-" + a.index : "")).attr({
                    zIndex: 1
                }).add(this.scrollGroup), a.legendItem = t = d.text("", m ? e + f : -f, this.baseline || 0, A), b.styledMode || t.css(l(a.visible ? k : h)), t.attr({
                    align: m ? "left" : "right",
                    zIndex: 2
            ...
            a.prototype.handleOverflow = function(a) {
                ...
                a && 0 < f && a > f && !1 !== p.enabled ? (this.clipHeight = h = Math.max(f - 20 - this.titleHeight - k, 0), this.currentPage = J(this.currentPage, 1), this.fullHeight =
                    a, A.forEach(function(a, b) {
                        ...
                        d !== v && (v = d)
                    }), m || (m = b.clipRect = c.clipRect(0, k, 9999, 0), b.contentGroup.clip(m)), I(h), w || (this.nav = w = c.g().attr({
                            zIndex: 1
                        }).add(this.group), this.up = c.symbol("triangle", 0, 0, n, n).add(w), N("upTracker").on("click", function() {
                            b.scroll(-1, t)
                        }), this.pager =
                        c.text("", 15, 10).addClass("highcharts-legend-navigation"), d.styledMode || this.pager.css(p.style), this.pager.add(w), this.down = c.symbol("triangle-down", 0, 0, n, n).add(w), N("downTracker").on("click", function() {
                            b.scroll(1, t)
                        })), b.scroll(0), a = f) : w && (I(), this.nav = w.destroy(), this.scrollGroup.attr({
                    translateY: 1
                }), this.clipHeight = 0);
                return a
            };
    ...
    L(a, "Core/Chart/Chart.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Axis/Axis.js"], a["Core/FormatUtilities.js"], a["Core/Foundation.js"], a["Core/Globals.js"], a["Core/Legend.js"], a["Core/MSPointer.js"],
        ...
        a = function() {
            ...
            a.prototype.drawChartBox = function() {
                ...
                e || (w.attr({
                    fill: k || "none"
                }).shadow(a.plotShadow), l && (g ? (l !== g.attr("href") && g.attr("href", l), g.animate(p)) : this.plotBGImage = b.image(l, h, I, r, m).add()));
                t ? t.animate({
                    width: n.width,
                    height: n.height
                }) : this.clipRect = b.clipRect(n);
                v = "animate";
                q || (v = "attr", this.plotBorder = q = b.rect().addClass("highcharts-plot-border").attr({
                    zIndex: 1
                }).add());
                e || q.attr({
            ...
            a.prototype.showLoading = function(a) {
                ...
                b.styledMode || (O(g, z(c.style, {
                    zIndex: 10
                })), O(f, c.labelStyle), b.loadingShown || (O(g, {
                    opacity: 0,
                    display: ""
                }), w(g, {
            ...
            a.prototype.update = function(a, b, d, c) {
                ...
                if (p) {
                    ...
                    T(p, function(a, b) {
                        -1 !== f.propsRequireUpdateSeries.indexOf("chart." + b) && (r = !0); - 1 !== f.propsRequireDirtyBox.indexOf(b) && (f.isDirtyBox = !0); - 1 !== f.propsRequireReflow.indexOf(b) && (l ? f.isDirtyBox = !0 : m = !0)
                    });
                    ...
                    b.forEach(function(b) {
                        if (b.options.panningEnabled &&
                            ...
                            b.isOrdinal || (r = p - h, 0 < r && (t += r, h = p), r = t - n, 0 < r && (t = n, h -= r), b.series.length && h !== m.min &&
                                t !== m.max && h >= p && t <= n && (b.setExtremes(h, t, !1, !1, {
                                    trigger: "pan"
                                }), d.resetZoomButton || g || h === p || t === n || !f.match("y") || (d.showResetZoom(), b.displayBtn = !1), k = !0), e[c] = l)
                        }
                    });
                    T(e, function(a, b) {
                        d[b] = a
    ...
    L(a, "Mixins/LegendSymbol.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function(a, u) {
        ...
        return a.LegendSymbolMixin = {
            drawRectangle: function(a, v) {
                ...
                v.legendSymbol = this.chart.renderer.rect(B ? (a.symbolWidth - u) / 2 : 0, a.baseline - u + 1, B ? u : a.symbolWidth, u, H(a.options.symbolRadius, u / 2)).addClass("highcharts-point").attr({
                    zIndex: 3
                }).add(v.legendGroup)
            },
            ...
            a.prototype.setData = function(a, b, d, c) {
                ...
                if (!C) {
                    ...
                    if (m && k > m)
                        ...
                        for (d = 0; d < k; d++) "undefined" !== typeof a[d] && (c = {
                            series: e
                ...
                if (!1 !== e.enabled || this._hasPointMarkers)
                    for (d = 0; d < a.length; d++) {
                        ...
                        if ((k && "undefined" === typeof p.enabled || p.enabled) && !l.isNull && !1 !== l.visible) {
                            ...
                            var n = !1 !== l.isInside;
                            c ? c[n ? "show" : "hide"](n).animate(t) : n && (0 < (t.width || 0) || l.hasImage) && (l.graphic = c = b.renderer.symbol(m, t.x, t.y, t.width, t.height, r ? p : e).add(g), this.enabledDataSorting && b.hasRendered && (c.attr({
                                x: l.startXPos
                            }), h = "animate"));
            ...
            a.prototype.setState = function(a, b) {
                ...
                if (d.state !== a && ([d.group, d.markerGroup, d.dataLabelsGroup].forEach(function(b) {
                    ...
                    if (e && !e.dashstyle)
                        for (f = {
                                "stroke-width": k
                            }, e.animate(f, h); d["zone-graph-" + c];) d["zone-graph-" +
                            c].animate(f, h), c += 1;
    ...
    L(a, "Series/Area/AreaSeries.js", [a["Core/Color/Color.js"], a["Mixins/LegendSymbol.js"],
        ...
        H = function(a) {
            ...
            c.defaultOptions = B(G.defaultOptions, {
                threshold: 0
            });
            return c
        }(G);
            ...
            d.prototype.drawPoints = function() {
                ...
                a.points.forEach(function(b) {
                    ...
                    if (J(b.plotY) && null !== b.y) {
                        ...
                        g || (b.graphic =
                            g = e[b.shapeType](k).add(b.group || a.group)) && a.enabledDataSorting && d.hasRendered && d.pointCount < f && (g.attr({
                            x: b.startXPos
                        }), l = !0, h = "animate");
                        if (g && l) g[h](K(k));
    ...
    L(a, "Core/Series/DataLabels.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Color/Palette.js"], a["Core/Series/Series.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function(a, u, E, H, x, y, G) {
        ...
        x.prototype.drawDataLabels = function() {
            ...
            if (m(h) || h.enabled || e._hasPointLabels) {
                ...
                !A && (A = e.dataLabelsGroup) && (e.visible && B.show(!0), A[f.animation ? "animate" : "attr"]({
                    opacity: 1
                }, C));
        ...
        y.pie && (y.pie.prototype.dataLabelPositioners = {
                ...
                a.visible && (f.enabled || a._hasPointLabels) && (d.forEach(function(a) {
                    ...
                    a.dataLabel && (a.visible ? (X[a.half].push(a), a.dataLabel._pos = null, !c(f.style.width) && !c(a.options.dataLabels && a.options.dataLabels.style && a.options.dataLabels.style.width) && a.dataLabel.getBBox().width > u && (a.dataLabel.css({
